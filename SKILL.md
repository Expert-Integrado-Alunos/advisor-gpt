...
Descobrir os scripts (nunca chumbar versão de cache; vale pro plugin `lab` e pro clone solto em `~/.claude/skills/advisor-gpt`, repositório público `github.com/Expert-Integrado-Alunos/advisor-gpt`):

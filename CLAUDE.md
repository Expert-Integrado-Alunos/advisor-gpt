...
- **Repositorio canonico:** `github.com/ericlucianoferreira/advisor-gpt` (GitHub pessoal do Eric; transferência pra org fica pra depois e muda a URL da página, do `og:image` e do `canonical`).
...
- Publicar: commit + push na `main`; Pages serve `/docs`. Prova: `curl -s --ssl-no-revoke "https://ericlucianoferreira.github.io/advisor-gpt/?v=$(date +%s)"` com 200 e conteúdo novo, e `/og.png` 200.
